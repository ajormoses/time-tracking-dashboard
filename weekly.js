...
fetch("data.json")
  ...
  .then((data) => {
    (title_work.innerHTML = data[0].title),
      (current_work.innerHTML = data[0].timeframes.weekly.current + "" + "hrs");
    prev_work.innerHTML = data[0].timeframes.weekly.previous + "" + "hrs";
    (title_play.innerHTML = data[1].title),
      (current_play.innerHTML = data[1].timeframes.weekly.current + "" + "hrs");
    prev_play.innerHTML = data[1].timeframes.weekly.previous + "" + "hrs";
    (title_study.innerHTML = data[2].title),
      (current_study.innerHTML =
        data[2].timeframes.weekly.current + "" + "hrs");
    prev_study.innerHTML = data[2].timeframes.weekly.previous + "" + "hrs";
    (title_exercise.innerHTML = data[3].title),
      (current_exercise.innerHTML =
        data[3].timeframes.weekly.current + "" + "hrs");
    prev_exercise.innerHTML = data[3].timeframes.weekly.previous + "" + "hrs";
    (title_social.innerHTML = data[4].title),
      (current_social.innerHTML =
        data[4].timeframes.weekly.current + "" + "hrs");
    prev_social.innerHTML = data[4].timeframes.weekly.previous + "" + "hrs";
    (title_self_care.innerHTML = data[5].title),
      (current_self_care.innerHTML =
        data[5].timeframes.weekly.current + "" + "hrs");
    prev_self_care.innerHTML = data[5].timeframes.weekly.previous + "" + "hrs";
  });
